...
for i in range (0,775):
    stock_name_full=sheel_1.cell_value(i,0)
    stock_id=stock_name_full[0:4]
    stock_name=stock_name_full[5:]
    stock_nalid=sheel_1.cell_value(i,1)
#market_date=str(sheel_1.cell_value(0,2))
    market_cass=sheel_1.cell_value(i,3)
    stock_cass=sheel_1.cell_value(i,4)

    stock_info={'stock_id':stock_id,'stock_name':stock_name,'stock_nalid':stock_nalid,'market_cass':market_cass,'stock_cass':stock_cass,'creat_time':datetime.now()}
